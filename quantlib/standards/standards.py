...
def get_span(granularity, granularity_multiplier, period_start=None, period_end=None, periods=None):
    ...
    """
    # if granularity in [Period.DAILY, Period.WEEKLY, Period.MONTHLY, Period.YEARLY]:
    #     period_start = period_start.date() if period_start else period_start
    #     period_end = period_end.date() if period_end else period_end
